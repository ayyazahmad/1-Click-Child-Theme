<?php
/**
 * Plugin Name: 1-Click Child Theme
 * Plugin URI: https://softlinks.co/wordpress/
 * Description: Creates a child theme from any theme you have installed
 * Version: 1.0
 * Author: Ayyaz Ahmad
 * Author URI: https://ayyazahmad.com
 * License: GPL3
 * License URI:  http://www.gnu.org/licenses/gpl-3.0.html
 */
 
/*  Copyright 2019-2020  Ayyaz Ahmad (email support@softlinks.co)
...
function ctw_menu() {
	...
	$starter_plugin_admin_page = add_submenu_page ('tools.php', __('1-Click Child Theme', 'ctw'), __('1-Click Child Theme', 'ctw'), 'manage_options', '1-ClickChildTheme', 'ctwMainFunction');
}
...
// check that the user has the required capability 
	...
	if( isset($_POST[ 'hiddenfield' ]) && $_POST[ 'hiddenfield' ] == 'Y' ) {
		...
		if ($status['alert'] == -1) {
            ...
            <div><strong><p>Would you like to <a href="<?php get_admin_url('tools.php?page=1-ClickChildTheme'); ?>">try again?</a></p></strong></div>
...
<?php // display the footer ?>
	<p><a href="https://azad.co" target="_blank"><img src="<?php  
	echo plugins_url('images/azad-header.png', __FILE__); ?>" width="300"></a> </p>

<p><a href="https://ayyazahmad.com/" target="_blank">Plugin by Ayyaz Ahmad</a> | <a href="https://github.com/ayyazahmad/1-Click-Child-Theme" target="_blank">Fork me or Contribute on GitHub</a> | <a href="https://azad.co/" target="_blank">AzAd Solutions - My Business</a></p>

<p><span><!-- Social Buttons -->

<!-- YouTube -->
<script src="https://apis.google.com/js/platform.js"></script>
<div class="g-ytsubscribe" data-channel="azadco"></div>
...
<!-- Twitter -->
<a href="https://twitter.com/softlinks?ref_src=twsrc%5Etfw" class="twitter-follow-button" data-show-count="true">Follow @softlinks</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script> 

<!-- Facebook -->
<iframe src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Fsoftlinks.co&width=450&layout=standard&action=like&size=small&share=true&height=35&appId=129298761141260" width="350" height="20" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
...
function cyb_activation_redirect( $plugin ) {
    if( $plugin == plugin_basename( __FILE__ ) ) {
        exit( wp_redirect( admin_url( 'tools.php?page=1-ClickChildTheme' ) ) );
    }
}
